...
print(f"Presist médio = {np.mean(p_resist_tempr):.3f}")
print(f"Rcomp médio = {np.mean(resist_compr):.3f}")
print(f"VE médio = {np.mean(taxa_vol_erosao):.3f}")
print(f"Desvio de VE = {np.std(taxa_vol_erosao):.3f}")
